...
<div id="sidebar" class="col-md-4 order-md-first col-sm-12 oder-sm-last">
	...
	?>
		<div id="widget-area" class="widget-area" role="complementary">
			...
			?>
				<span class="edit-link"><a href="<?php echo esc_url( admin_url( 'widgets.php' ) ); ?>" class="badge badge-secondary"><?php esc_html_e( 'Edit', 'ebook' ); ?></a></span><!-- Show Edit Widget link -->
			<?php
				endif;
			?>
		</div><!-- /.widget-area -->
	...
	?>
		<div class="bg-faded sidebar-nav">
			<div id="primary-two" class="widget-area">
				<?php
					$output = '<ul class="recentposts">';
						...
						if ( $recentposts_query->have_posts() ) :
							$output .= '<li><h3>' . esc_html__( 'Recent Posts', 'ebook' ) . '</h3></li>';
							while ( $recentposts_query->have_posts() ) :
								...
								$output .= '<h4><a href="' . esc_url( get_the_permalink() ) . '" title="' . esc_attr( sprintf( __( 'Permalink to %s', 'ebook' ), the_title_attribute( 'echo=0' ) ) ) . '" rel="bookmark">' . esc_html( get_the_title() ) . '</a></h4>';
								$output .= '</li>';
							endwhile;
						endif;
						wp_reset_postdata();
				...
				<br />
				<ul class="categories">
					<li><h3><?php esc_html_e( 'Categories', 'ebook' ); ?></h3></li>
					<?php
					...
					?>
							<li>&nbsp;</li>
							<li><a href="<?php echo esc_url( get_the_permalink( get_option( 'page_for_posts' ) ) ); ?>" class="btn btn-outline-secondary"><?php esc_html_e( 'more', 'ebook' ); ?></a></li>
					<?php
						endif;
					?>
				</ul>
